...
<div class="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-6 gap-4">
    ...
    <div class="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
        ...
        <select id="jabatanFilter" class="border-gray-300 rounded-lg focus:border-gold-500 focus:ring-gold-500 text-gray-700">
            ...
            {{-- [BARU] Looping data jabatan dari database --}}
    ...
    <div class="flex flex-wrap gap-3 w-full xl:w-auto justify-end">
        ...
        <div class="flex rounded-md shadow-sm" role="group">
            <a href="{{ route('admin.employees.export-excel') }}" class="px-4 py-2.5 text-sm font-semibold text-green-700 bg-green-100 border border-green-200 rounded-l-lg hover:bg-green-200 focus:z-10 focus:ring-2 focus:ring-green-300 flex items-center">
                <i class="fa-solid fa-file-csv mr-2"></i> CSV
            </a>
            <a href="{{ route('admin.employees.export-pdf') }}" class="px-4 py-2.5 text-sm font-semibold text-red-700 bg-red-100 border border-l-0 border-red-200 rounded-r-lg hover:bg-red-200 focus:z-10 focus:ring-2 focus:ring-red-300 flex items-center">
...
<div id="tableContainer" class="transition-opacity duration-200">
    {{-- Pastikan file partials/table.blade.php untuk employees sudah ada --}}
...
<script>
    ...
    function bulkExport(type) {
        ...
        let url = '';
        if (type === 'excel') url = "{{ route('admin.employees.export-excel') }}";
        if (type === 'pdf') url = "{{ route('admin.employees.export-pdf') }}";
