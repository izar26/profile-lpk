...
<head>
    ...
    <style>
        ...
        /* Kop Surat */
        .header-table { width: 100%; border-bottom: 3px double black; padding-bottom: 10px; margin-bottom: 20px; }
        .header-table td { border: none; vertical-align: middle; }
        .logo-cell { width: 10%; text-align: center; }
        .text-cell { width: 90%; text-align: center; }
        ...
        .lpk-contact { font-size: 9pt; font-style: italic; }
    </style>
</head>
<body>
        ...
        <tr>
            <td class="logo-cell">
                @if(isset($profile) && $profile->logo)
                    <img src="{{ public_path('storage/' . $profile->logo) }}" width="60" height="auto">
                @endif
            </td>
            <td class="text-cell">
                <h1 class="lpk-name">{{ isset($profile) ? $profile->nama_lpk : config('app.name') }}</h1>
                @if(isset($profile))
    ...
    <div style="margin-top: 30px; float: right; width: 200px; text-align: center;">
        <p>Mengetahui,</p>
        <br><br><br>
        <p style="border-top: 1px solid #000; display: inline-block; width: 150px; padding-top: 5px;">
            Pimpinan LPK
        </p>
    </div>
