...
<head>
    ...
    <style>
        ...
        .card {
            ...
            @else
                /* Jika ingin warna merah khas siswa, ganti #1e3a8a dengan #8B0000 */
        ...
        /* Wrapper Jabatan (Diisi 'SISWA' agar layout sama) */
        .jabatan-wrapper {
            display: block;
            text-align: center;
            margin-bottom: 4px;
            ...
            <div class="card">
                ...
                <div class="info-section">
                    ...
                    <div class="jabatan-wrapper">
                        <div class="jabatan-badge">SISWA</div>
                    </div>
                ...
                <div class="qr-section">
                    <div class="qr-box">
                        {{-- Menggunakan route student.verify sesuai data siswa --}}
