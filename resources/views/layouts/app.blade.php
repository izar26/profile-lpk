        ...
        <div class="h-full px-3 pb-6 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                ...
                @if(Auth::user()->isAdmin())
                    ...
                    <li>
                        <a href="{{ route('admin.fee-components.index') }}" class="flex items-center p-2 rounded-lg group transition-colors duration-200 {{ request()->routeIs('admin.fee-components.*') ? 'bg-gold-500 text-white font-bold shadow-md' : 'text-gray-700 hover:bg-gold-50 hover:text-gold-600' }}">
                            <i class="fa-solid fa-file-invoice-dollar w-5 h-5 transition duration-75 {{ request()->routeIs('admin.fee-components.*') ? 'text-white' : 'text-gray-500 group-hover:text-gold-600' }}"></i>
                            <span class="ms-3">Rincian Biaya</span>
                        </a>
                    </li>
